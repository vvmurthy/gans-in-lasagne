...
def train_icgan(configuration):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for X_files_mem, y_train_mem in iterate_membatches(X_files_train, y_train, images_in_mem, dataset_loader, li, shuffle=True):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        show_reconstructions(ims, reconstructions, li, nc, epoch, base + 'images/reconstructions_epoch' + str(epoch) + '.png')
